...
if(isset($_POST['sendAlldonors'])){
     $messtext = $_POST['messtext'];


      $query = mysqli_query(DB::con(), "SELECT donor_mobile FROM donorinfo WHERE status = 1");
...
//      echo $smsresult;
     if($smsresult==true){
            $query = mysqli_query(DB::con(), "INSERT INTO donorallmessage (messtext) VALUES('$messtext')");
            if($message){
                  $message = header("Location:dashboard.php");
            }
     }else{
            ...
            <div class="col-md-8 m-auto ">
                  <form action="" method="post">
                        <div class="card p-3">
                              ...
                              <div class="card-body">
                                    <p class="text-center"><strong>সকল দাতাকে মেসেজ পাঠান</strong></p>
                                    ...
                                    <div class="form-group text-end ">
                                          <button class="btn btn-primary my-3"  onclick="return confirm('আপনি কি সকল দাতাদেরকে এই মেসেজটি পাঠাতে চাচ্ছেন ??')" name="sendAlldonors">বার্তা প্রেরন করুন</button>
                                    </div>
                              </div>
                        </div>
                  </form>
