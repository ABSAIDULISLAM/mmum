...
<div class="container">
      <div class="row">
            ...
            <table class="table table-bordered table-hover display" id="example" style="100%">
                  <thead class="bg my-2">
                        <tr>
                              <th>ক্র.</th>
                  ...
                  <tbody>
                        ...
                        <tr>
                              ...
                              <td>
                                    ...
                                    <a href="viewStudent.php?view=<?php echo $studentInfo['id'] ?>" class="btn btn-success btn-sm " title="ভিউ"><i class="bi bi-eye"></i></a>
...
if(isset($_POST['addsession'])){
      AddClasses::addSession($_POST);
}


?>
 <!-- modal for  add session    -->
 <div class="modal fade" id="addsession" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                        <div class="modal-content">
                              <div class="modal-header">
                              <h5 class="modal-title" id="staticBackdropLabel">সেশন তৈরী</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              ...
                              <div class="modal-body">
                                          ...
                                          <div class="form-group">
                                                <div class="card">
                                                      <div class="card-body">
                                                            ...
                                                            <div class="form-group my-2">
                                                                  <label for="">সেশন </label>
                                                                  <input type="text" required name="session" class="form-control mt-2">
                                                            </div>
                                    ...
                                    <div class="text-end">
                                    <button type="submit" class="btn btn-primary" name="addsession" >সংরক্ষন করুন</button>
                                    </div>
                                    </form>
                              </div>
                        </div>
